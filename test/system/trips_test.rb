...
class TripsTest < ApplicationSystemTestCase
  ...
  test "should create trip" do
    ...
    fill_in "Client", with: @trip.client
    fill_in "Driver", with: @trip.driver
    fill_in "End date", with: @trip.end_date
    fill_in "Ending", with: @trip.ending
    fill_in "Running", with: @trip.running
    fill_in "Start date", with: @trip.start_date
    fill_in "Starting", with: @trip.starting
